 ...
 * @author hp
 */
public class Evo extends javax.swing.JFrame {
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        table = "datos";
        columns = "Nombre,Fecha,Edad,Sexo,Telefono,Correo,Domicilio,Motivo";
        values = datos.getNombre() + Date.valueOf(datos.getFecha()) + datos.getEdad() + datos.getSexo()
                + datos.getTelefono() + datos.getCorreo() + datos.getDomicilio() + datos.getMotivo();
        ...
        try {
            PreparedStatement datosPS = statement.insertIntoDatos(con);
            PreparedStatement antecedentesPS = statement.insertIntoAntecedentes(con);
            PreparedStatement examenFisicoPS = statement.insertIntoExamenFisico(con);
            PreparedStatement examenNeurologicoPS = statement.insertIntoExamenNeurologico(con);
            PreparedStatement exNeTablas1PS = statement.insertIntoExNeTablas1(con);
            PreparedStatement exNeTablas2PS = statement.insertIntoExNeTablas2(con);
            PreparedStatement monitosPS = statement.insertIntoMonitos(con);
            PreparedStatement evolucionFechaPS = statement.insertIntoEvolucionFecha(con);
            PreparedStatement evolucionPS = statement.insertIntoEvolucion(con);
            
            int res = datosPS.executeUpdate();
            int res2 = antecedentesPS.executeUpdate();
            int res3 = examenFisicoPS.executeUpdate();
            int res4 = examenNeurologicoPS.executeUpdate();
            int res5 = exNeTablas1PS.executeUpdate();
            int res6 = exNeTablas2PS.executeUpdate();
            int res7 = monitosPS.executeUpdate();
            int res8 = evolucionFechaPS.executeUpdate();
            int res9 = evolucionPS.executeUpdate();
            
            
            if(res>0 && res2>0 && res3>0 && res4>0 && res5>0 && res6>0 && res7>0 && res8>0 && res9>0)
            {
    ...
    private void regresarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regresarButtonActionPerformed
        Admin.returnExamenNeurologico3();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Evo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
