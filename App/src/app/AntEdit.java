 ...
 * @author hp
 */
public class AntEdit extends javax.swing.JFrame {
    ...
    public static void fillRadioButtons()
    {
        ...
        try{
        PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT antecedentes.* from antecedentes WHERE antecedentes.Id_ante = ?");
        ps.setString(1, tP.getID());
        rs = ps.executeQuery();
        while(rs.next()){            
             datos[0]=rs.getString("Diabetes");
             datos[1]=rs.getString("Hipertension");
             datos[2]=rs.getString("Obesidad");
             datos[3]=rs.getString("Tabaquismo");
             datos[4]=rs.getString("Alcoholismo");
             datos[5]=rs.getString("Drogas");
             datos[6]=rs.getString("Otro");
        }
        con.close();
    ...
    private void siguienteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteButtonActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "¿Desea guardar los cambios realizados?", "Advertencia", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if(dialogButton == JOptionPane.YES_OPTION)
        {
        String table = "antecedentes";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AntEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
