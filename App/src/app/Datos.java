...
public class Datos<T> extends javax.swing.JFrame {
    ...
    public static void setFecha(String f) {
        StringBuilder builder = new StringBuilder(f);
        fecha = builder.reverse().toString();
    }
    ...
    private void motivoTAKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_motivoTAKeyReleased
        ...
        /*int line = motivoTA.getLineCount() - 1;
        try {
            int start = motivoTA.getLineStartOffset(line);
            int end = motivoTA.getLineEndOffset(line);
            String sLine = motivoTA.getText(start,end);
            if(sLine.length()%20==0)
            {
                motivoTA.append("\n");
            }
        ...
        /*for (String line : motivoTA.getText().split("\\n")) 
        {
            if(line.length()>=20)
            {
                motivoTA.append("\n");
    ...
    private void motivoTAKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_motivoTAKeyPressed
        /*int counter = 0;
        for(int i=0; i<motivoTA.getText().length(); i++)
        {
            if(motivoTA.getText().charAt(i) != '\n')
                counter++;
        }
    ...
    }//GEN-LAST:event_motivoTAKeyPressed
